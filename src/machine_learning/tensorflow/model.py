...
def construct_model(n_class: int) -> tf.keras.Model:
    ...
    concate2 = Concatenate()([mobilenet, input2, input3, input4])
    dense1 = Dense(512, activation="relu")(concate2)
    dropout1 = Dropout(0.3)(dense1)
    dense2 = Dense(512, activation="relu")(dropout1)
    dropout2 = Dropout(0.3)(dense2)
    pred = Dense(n_class, activation="softmax")(dropout2)
    return tf.keras.Model(inputs=[input1, input2, input3, input4], outputs=pred)
